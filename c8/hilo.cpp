...
// (e.g. if we wanted to move the won/lost messages out of the function, or conditional other behavior based on won/lost)
void playHiLo(int guesses, int min, int max)
{
...
int main()
{
	do
	{
		playHiLo(Configuration::guesses, Configuration::min, Configuration::max);
	} while (playAgain());
